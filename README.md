...
- **Target Selector**: Identify the element to animate using its ID (`#id`).
- **Custom Element Alias**: Available for `Passive Receiver (Target)` and `Hybrid` roles to set target IDs.
